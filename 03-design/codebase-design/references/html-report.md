...
Tailwind and Mermaid both come from CDNs. Mermaid handles graph-shaped diagrams reliably;
...
([language.md](language.md)) without ceremony.
...
- **Wins** — bullets, ≤6 words each. e.g. "Tests hit one interface", "Pricing logic stops
...
positioned absolutely over a relative container. Reach for this when you want the "after" diagram
to feel like one thick-bordered deep module with greyed-out internals — Mermaid won't render that
...
make it a bullet. If a bullet could be cut, cut it. If a term isn't in [language.md](language.md),
