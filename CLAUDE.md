...
This is a **Claude Code plugin** (`engineering-skills`) — a curated pack of 42 agent
...
- Every skill links `${CLAUDE_PLUGIN_ROOT}/references/engineering-principles.md` — the distilled discipline. PM-side skills (brainstorm, spec, oss-strategy, market-research, tech-selection) also link `references/product-principles.md`; UIUX skills (frontend-design, image-to-code, imagegen, prototype) also link `references/design-principles.md` — domain discipline layers atop the shared engineering base.
