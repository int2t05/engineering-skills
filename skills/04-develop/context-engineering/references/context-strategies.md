...
**Equivalent files for other tools:** `.cursorrules` or `.cursor/rules/*.md`
...
| Silent confusion | Agent guesses when it should ask | Surface ambiguity explicitly using the confusion management patterns |
