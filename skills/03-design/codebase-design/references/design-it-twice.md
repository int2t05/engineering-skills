...
parallel sub-agent pattern. Based on "Design It Twice" (Ousterhout) — your first idea is unlikely
to be the best.

Uses the vocabulary in [language.md](language.md) — **module**, **interface**, **seam**,
**adapter**, **leverage**. For the criteria used to compare designs, see
...
Include both [language.md](language.md) vocabulary and CONTEXT.md vocabulary in the brief so each
...
placement**. See [interface-design.md](interface-design.md) for the full comparison criteria.
